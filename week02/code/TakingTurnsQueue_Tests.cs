...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: When adding a person, the person added was inserted at the first of the queue instead of the end of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: A person with zero turns was not being treated as having infinite turns.
    ...
    // Defect(s) Found: A person with negative turns was not being treated as having infinite turns.
